...
vim.api.nvim_command(
    "command! -nargs=1 -complete=dir DeployDockerImage lua require('pkg/ops/docker').DeployDockerImage(<f-args>)"
)
vim.api.nvim_command(
    "command! -nargs=1 -complete=dir DeployAllDockerImages lua require('pkg/ops/docker').DeployAllDockerImages(<f-args>)"
)
...
---------------------------------------------------------------------------------
vim.api.nvim_command(
    "command! -nargs=* -complete=dir CreateCluster lua require('pkg/ops/kubernetes').CreateCluster(<f-args>)"
)
vim.api.nvim_command(
    "command! -nargs=* -complete=dir DeployHelmChart lua require('pkg/ops/kubernetes').DeployHelmChart(<f-args>)"
)
vim.api.nvim_command(
    "command! -nargs=1 -complete=dir DeployAllHelmCharts lua require('pkg/ops/kubernetes').DeployAllHelmCharts(<f-args>)"
)
